...
def run_sim(hyp,opt,device):
    ...
    if opt.oodnumeffect :
        ...
        ood_num_effect(data,device,hyp["oodnumeffect"])
    ...
    if opt.sim_ood_score:
        print("OoD Scores")
        ood_performance(data,device,hyp["scod_model"],hyp["general"],opt.sim_result_loc)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--oodnumeffect",action="store_true")
